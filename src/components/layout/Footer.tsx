...
function Footer() {
  const instagramUrl = import.meta.env.VITE_INSTAGRAM_URL || 'https://instagram.com/cutsandcomb';
  const facebookUrl = import.meta.env.VITE_FACEBOOK_URL || 'https://facebook.com/cutsandcomb';
  const phoneNumber = import.meta.env.VITE_PHONE_NUMBER || '9994421126';
  const phoneDisplay = '99944 21126'; // Formatted for display
    ...
    <footer className="bg-secondary-900 text-white">
      <div className="container-custom py-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="hover:text-primary-400 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
        ...
        <div className="mt-8 pt-8 border-t border-secondary-700 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Cuts & Comb. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
